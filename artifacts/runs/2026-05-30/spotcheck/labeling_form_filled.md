...
- notes: General definition; broadly accurate and answers the question despite no retrieved evidence.
...
- faithfulness (0–10): `[1]`
- answer_relevance (0–10): `[0]`
- question_coverage (0–10): `[0]`
- calibration (0–10): `[7]`
- overall_pass (0 or 1): `[0]`
- notes: Does not answer the question. Electricity pricing is a generic topic and does not require a building address.
...
- calibration (0–10): `[6]`
- overall_pass (0 or 1): `[1]`
- notes: you should ask specifically for the address instead of listing all that things
