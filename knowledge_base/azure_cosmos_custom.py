...
class AzureCosmosDBNoSqlVectorSearchCustom(VectorStore):
    ...
    def _from_kwargs(
        ...
        *,
        ...
        create_container: bool = True,
        **kwargs: Any,
    ) -> AzureCosmosDBNoSqlVectorSearchCustom:
        if kwargs:
            warnings.warn(
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        """
        vectorstore = AzureCosmosDBNoSqlVectorSearchCustom._from_kwargs(embedding, **kwargs)
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        mmr_doc_indexes = maximal_marginal_relevance(
            np.array(embedding),
            [self._embedding.embed_query(doc.page_content) for doc, _ in docs],
            k=k,
